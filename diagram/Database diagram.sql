...
CREATE TABLE IF NOT EXISTS `backend`.`emailotp` (
  ...
  `otp_type` ENUM('register', 'forgot_password', 'change_email', '2fa') CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT 'register',
  ...
  `device_fingerprint` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `backend`.`orders` (
  ...
  `order_code` VARCHAR(20) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `backend`.`products` (
  ...
  `packaging_spec` VARCHAR(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
  `description` TEXT CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
  `long_description` TEXT CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
  `origin` VARCHAR(100) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT 'Việt Nam',
...
CREATE TABLE IF NOT EXISTS `backend`.`payments` (
  ...
  `payment_method` ENUM('Cash', 'OnlineBanking') CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
  `payment_status` ENUM('Pending', 'Completed', 'Failed') CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NULL DEFAULT NULL,
